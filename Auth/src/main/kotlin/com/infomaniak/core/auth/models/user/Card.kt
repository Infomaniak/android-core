...
data class Card(
    ...
    fun makeVCardString(forQRCode: Boolean = false, avatarBase64: String? = null, avatarMimeType: String? = null): String = buildString {
        ...
        if (!forQRCode) {
            avatarBase64?.let { emit("PHOTO;ENCODING=b;TYPE=${avatarMimeType ?: "JPEG"}:$it") }
        }

...
abstract class RoomCredentialManager : CredentialManager() {
     ...
     */
    final override fun getAllUsers(): LiveData<List<User>> = userDatabase.userDao().getAll()

    final override fun getAllUsersCount(): Int = userDatabase.userDao().count()
    ...
    final override suspend fun getUserById(id: Int): User? = userDatabase.userDao().findById(id)
}

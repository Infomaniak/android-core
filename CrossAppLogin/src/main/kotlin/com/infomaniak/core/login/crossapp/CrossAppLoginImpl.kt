...
internal class CrossAppLoginImpl(private val context: Context) : CrossAppLogin {
    ...
    init {
        ...
        targetPackageNames = certificateChecker.signingCertificates
            .packageNames.filterTo(mutableSetOf()) {it != ourPackageName }
    }

    override val sharedDeviceIdManager = SharedDeviceIdManager(context, certificateChecker, targetPackageNames)

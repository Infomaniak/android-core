...
internal class CrossAppLoginImpl(private val context: Context) : CrossAppLogin {
    ...
    private val certificateChecker: AppCertificateChecker = AppCertificateChecker.withInfomaniakApps
    private val targetPackageNames: List<String>

    init {
        val ourPackageName = context.packageName
        targetPackageNames = certificateChecker.signingCertificates.packageNames.filter { it != ourPackageName }
    }

    private val sharedDeviceIdManager = SharedDeviceIdManager(context, certificateChecker, targetPackageNames)
    ...
    override suspend fun getSharedDeviceInstanceId() = sharedDeviceIdManager.getSharedDeviceId()

...
inline fun <reified T> apiEnum(backingFieldProperty: KProperty0<String>): ReadOnlyProperty<Any?, T?> where T : Enum<T>, T : ApiEnum {
    return ReadOnlyProperty { _, _ -> apiEnumValueOfOrNull<T>(backingFieldProperty.get()) }
}

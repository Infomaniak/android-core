 ...
 */
package com.infomaniak.core.common.time
...
fun Duration.timeOffFromWholeDays(): Duration = this - this.inWholeDays.days
...
fun Duration.timeToNextDay(): Duration = 1.days - timeOffFromWholeDays()
